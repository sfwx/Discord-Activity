...
sh stt/install.sh
```
> **[ ! ]** Sempre que aparecer para substituir uma pasta/ou arquivo use **`y`**. Após instalar os pacotes você irá para dentro do arquivo **`status.json`** e é nescessário substituir as informações que deseja. Aproveite e desfrute do sistema.
